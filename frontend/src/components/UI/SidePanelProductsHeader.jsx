...
const SidePanelProductsHeader = props => {
  ...
  const showPicto =
    appStyles.mediaQueries.tablet > document.documentElement.clientWidth &&
    props.isMainPanelOpened;
  ...
  const pictoUrl = props.pictoUrl
    ? new URL(props.pictoUrl).origin + new URL(props.pictoUrl).pathname
    : "";

  return (
    <div style={styles.mainWrapper}>
      <div style={styles.wrapper1} onClick={props.onClickCallback} key={1}>
        <img src={arrow} style={styles.arrow} alt="back" />
      </div>
      <div style={styles.wrapper2} key={2}>
        <img alt={"picto"} style={styles.picto} src={pictoUrl} />
