...
const IntroAnimationDumb: React.StatelessFunctionalComponent<Props> = props => (
  <div
    className={
      "intro--wrapper " +
      (props.keyframe >= INTRO_FINISHED ? "transparent" : "")
    }>
    <img
      src={frame1}
      alt="logo"
      className={
        "logo " + (props.keyframe !== LOGO_FRAME1 ? " transparent " : "")
      }
    />
    <img
      src={frame2}
      alt="logo"
      className={
        "logo " + (props.keyframe !== LOGO_FRAME2 ? " transparent " : "")
      }
    />
    <img
      src={frame3}
      alt="logo"
      className={
        "logo " + (props.keyframe !== LOGO_FRAME3 ? " transparent " : "")
      }
    />
  </div>
);
