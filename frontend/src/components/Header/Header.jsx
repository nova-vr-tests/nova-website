...
import {coord2CircDefault} from "../Presentation/SidePanel/helpers.jsx";
...
const mapDispatchToProps: MapDispatchToProps<ReduxDispatch> = function(
  ...
  return {
    updateSidebarIntersection: sidebarInterserction =>
      dispatch(updateSidebarIntersection(sidebarInterserction)),
...
const Svg = (props: SvgProps) => {
  ...
  return (
    <svg
      ...
      version="1.1">
      <path d={path} fill={color} stroke="rgba(0, 0, 0, 0)" strokeWidth="3" />
    </svg>
  );
};
