...
const HomePage = props => {
    const source = `We provide XR Media solutions for business. Our work includes sourcing development, production management, and market entry.

(XR) Extended Reality refers to all real-and-virtual combined environments and human-machine interactions generated by computer technology and wearables. It includes representative forms such as:
