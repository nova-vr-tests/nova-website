...
const getDefaultStyles = props => {
  ...
  const headings = [
    ...
    {
      ...headingDefaultStyles,
      margin: `calc(0.75 * ${appStyles.unitHeight}) 0 calc(0.75 * ${
        appStyles.unitHeight
      }) calc(0.5 * ${appStyles.unitWidth}) `, // h2
      fontSize: "1.7rem",
      fontWeight: "normal",
    },
    {
      ...headingDefaultStyles,
      margin: `calc(0.5 * ${appStyles.unitHeight}) 0 calc(0.5 * ${
        appStyles.unitHeight
      }) calc(0 * ${appStyles.unitWidth}) `, // h2
      fontWeight: "normal",
      fontSize: "1.5rem",
    },
    {
