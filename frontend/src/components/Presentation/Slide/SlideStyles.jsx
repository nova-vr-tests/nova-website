...
const getStyles = props => {
  ...
  return {
    ...
    slideParagraphs: {
      height:
        "calc(" +
        (24 - headerHeightCoef - footerHeightCoef - 4) +
        " * " +
    ...
    tail: {
      ...
      opacity: props.pages[props.currentPage].showNextSectionArrow
        ? "inherit"
        : 0,
      pointerEvents: props.pages[props.currentPage].showNextSectionArrow
        ? "inherit"
        : "none",
      display: props.pages[props.currentPage].showNextSectionArrow
        ? "inherit"
        : "none",
    },
    title: {
