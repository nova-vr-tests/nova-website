    ...
    render() {
        ...
        const styles = {
            wrapper: {
                ...
                overflow: 'hidden',
                height: '100%',
                backgroundColor: window.location.pathname !== "/" && this.props.isMainPanelOpened && appStyles.mediaQueries.tablet > this.props.windowWidth ?  'rgba(0, 0, 0, 0)' : 'rgba(0, 0, 0, 0.4)',
            },
            frontSlide: {
                height: '100vh',
                width: '100%',
