...
import getStyles from "./FooterStyles.jsx";
...
const mapDispatchToProps: MapDispatchToProps<ReduxDispatch> = function(
  ...
  return {
    ...
    updateIsFooterOpened: isFooterOpened =>
      dispatch(updateIsFooterOpened(isFooterOpened)),
    updateCurrentFooterPage: currentFooterPage =>
      dispatch(updateCurrentFooterPage(currentFooterPage)),
  };
};
...
const FooterDumb: React.StatelessFunctionalComponent<Props> = props => {
  ...
  return (
    <div className="footer--wrapper" style={styles.footerWrapper}>
      ...
      <div style={styles.footerBackground} className={"footer-background "}>
      ...
      <div style={styles.quickLinks}>
        <span
          ...
          style={{
            color:
              props.currentFooterPage === footerPage.BUILDXR &&
              props.isFooterOpened
                ? "black"
                : "rgba(0, 0, 0, 0.4)",
        ...
        <span
          ...
          style={{
            color:
              props.currentFooterPage === footerPage.LEGALS &&
              props.isFooterOpened
                ? "black"
                : "rgba(0, 0, 0, 0.4)",
            marginLeft: "1rem",
        ...
        <span
          ...
          style={{
            color:
              props.currentFooterPage === footerPage.CONTACT &&
              props.isFooterOpened
                ? "black"
                : "rgba(0, 0, 0, 0.4)",
            marginLeft: "1rem",
        ...
        <span
          ...
          style={{
            color:
              props.currentFooterPage === footerPage.LOGIN &&
              props.isFooterOpened
                ? "black"
                : "rgba(0, 0, 0, 0.4)",
            marginLeft: "1rem",
...
const FooterSmart = compose(
  withState("bgUrl", "setBgUrl", aboutBg),
