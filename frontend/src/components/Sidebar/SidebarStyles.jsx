...
const getSidebarSectionStyles: GetStyles<SidebarSectionProps, SidebarSectionStyles> = props => {
    ...
    return {
        ...
        section: {
            wrapper: {
                ...
                minHeight: 'calc('
                      + (props.linePosition === props.id.section && window.location.pathname !== '/' ? '' : '') +
...
const getSidebarSubSectionStyles: GetStyles<void, SidebarSubSectionStyles> = () => {
    const unitHeight = constants.styles.unitHeight
    const sidebarWidth =  constants.styles.sidebar.widthFactor + ' * ' + constants.styles.unitWidth
