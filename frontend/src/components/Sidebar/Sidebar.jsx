...
const SidebarSubSection: React.StatelessFunctionalComponent<
  SidebarSubSectionProps,
> = props => {
...
> = props => {
  ...
  return (
    <div
      ...
      style={{
        ...styles.viewWrapper,
        ...(props.isOpened ? styles.viewWrapperOpened : {}),
      }}>
      <div
        style={{
          ...styles.section.wrapper,
          ...(props.isOpened ? styles.section.opened : {}),
        }}>
        <div style={styles.section.titleWrapper}>
          <div
            style={{
              ...styles.section.title,
              ...(props.isOpened ? styles.section.titleActive : {}),
            }}
            onClick={onClick}>
            {section.title}
          </div>
        </div>
        <div style={styles.subSections.wrapper}>{parseSection()}</div>
      </div>
    </div>
  );
};

const SidebarDumb: React.StatelessFunctionalComponent<
  SidebarDumbProps,
> = props => {
...
const mapDispatchToProps: MapDispatchToProps<ReduxDispatch> = function(
  ...
  return {
    goTo: () => {
      dispatch(updateIsFooterOpened(false));
    },
...
class Sidebar extends React.Component<Props, State> {
  ...
  componentWillUpdate(nextProps) {
    ...
    const isMobile =
      document.documentElement.clientWidth < styles.mediaQueries.phone;
